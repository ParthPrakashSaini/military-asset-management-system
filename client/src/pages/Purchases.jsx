...
import PurchaseForm from "../components/PurchaseForm"; // <-- Import the form
...
const Purchases = () => {
  ...
  useEffect(() => {
    fetchPurchases();
    // Only fetch dropdown data if user can create purchases
    if (userRole === "Admin" || userRole === "Logistics Officer") {
      fetchDropdownData();
    }
  }, [userRole]); // Re-run if role changes (though unlikely)
  ...
  // Only show the 'New Purchase' button to authorized roles
  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-brand-dark">Purchase History</h1>
        {canCreate && (
          <button
